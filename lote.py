...
class SubastaDato:
    ...
    def __init__(self, data):
        ...
        self.fechaInicio.append(regexClean(r"Fecha de inicio</th><td>[^<//td>]*", data)[24:])
        self.fechaFin.append(regexClean(r"Fecha de conclusión</th><td><strong class=\"destaca\">[^<//]*", data)[52:])
        self.cantidadReclamada.append(regexClean(r"Cantidad reclamada</th><td>[^<//]*", data)[27:])
        ...
        self.valorSubasta.append(regexClean(r"Valor subasta</th><td>[^<\>]*", data)[22:])
        self.tasacion.append(regexClean(r"Tasación</th><td>[^<\>]*", data)[21:])
        self.pujaMinima.append(regexClean(r"Puja mínima</th><td>[^<\>]*", data)[20:])
        self.tramosEntrePujas.append(regexClean(r"Tramos entre pujas</th><td>[^<\>]*", data)[27:])
        self.importeDeposito.append(regexClean(r"Importe del depósito</th><td>[^<\>]*", data)[29:])
...
class Lote:
    ...
    def __init__(self, data):
        ...
        self.valorSubasta.append(regexClean(r"Valor Subasta</th><td>[^<//td>]*", data)[22:])
        self.importeDeposito.append(regexClean(r"Importe del depósito</th><td>[^<//td>]*", data)[29:])
        self.pujaMinima.append(regexClean(r"Puja mínima</th><td>[^<//td>]*", data)[20:])
        self.tramosEntrePujas.append(regexClean(r"Tramos entre pujas</th><td>[^<//td>]*", data)[27:])
